...
local theme = {
    ...
    Cursor = { fg = color_utils.invert_color(colors.base05) },
    ...
    PreProc = { fg = colors.base0F },
    Include = { fg = colors.base0F },
    Define = { fg = colors.base0F },
    Macro = { fg = colors.base0F },
    PreCondit = { fg = colors.base0F },
