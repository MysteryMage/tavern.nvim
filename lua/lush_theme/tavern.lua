...
local theme = lush(function()
    return {
        ...
        Directory    { fg = colors.base0D, gui = 'bold'}, -- Directory names (and other special names in listings)
        ...
        IncSearch    { bg = colors.base0A, fg = colors.base0A.rotate(180) }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
        ...
        NormalFloat  { bg = Normal.bg.darken(10), fg = Normal.fg }, -- Normal text in floating windows.
        -- NormalNC     { }, -- normal text in non-current windows
        Pmenu        {  bg = Normal.bg.lighten(10), fg = Normal.fg }, -- Popup menu: Normal item.
        ...
        Identifier     { fg = colors.base08 }, -- (*) Any variable name
        Function       { fg = colors.base0D }, --   Function name (also: methods for classes)
            ...
            Repeat         { fg = colors.base0E }, --   for, do, while, etc.
                ...
                Type           { fg = colors.base09 }, -- (*) int, long, char, etc.
                StorageClass   { fg = colors.base0E }, --   static, register, volatile, etc.
                Structure      { fg = colors.base09 }, --   struct, union, enum, etc.
                Typedef        { fg = colors.base09 }, --   A typedef
